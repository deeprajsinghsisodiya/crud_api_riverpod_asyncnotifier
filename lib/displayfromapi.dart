...
class MyNotifier extends AsyncNotifier<List<Userupdate>> {
  ...
  ///Post for update the data. Results will be visible
...
///POST TO register https://reqres.in/ Check for more details
// Future<List<Userupdate>> getData() async {
...
/// Go to https://app.quicktype.io/ make the DB
